...
# Example usage
data = pd.read_csv('../f1/24_25/F1_060425.csv')  # Make sure this is the correct path to your CSV
data['Date'] = pd.to_datetime(data['Date'])  # Ensure the 'Date' column is in datetime format

# List of upcoming matches
upcoming_matches = pd.DataFrame({
    'HomeTeam': ['Lens', 'Monaco', 'Toulouse', 'Strasbourg', 'St Etienne', 'Angers', 'Le Havre', 'Auxerre'],
    'AwayTeam': ['Reims', 'Marseille', 'Lille', 'Nice', 'Brest', 'Montpellier', 'Rennes', 'Lyon']
})
