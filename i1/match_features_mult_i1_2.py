...
def compute_home_shots_rolling_avg(data, home_team, match_date=None, window=window_):
...
def compute_away_shots_rolling_avg(data, away_team, match_date=None, window=window_):
    if match_date is None:
        match_date = datetime.now()
...
def compute_home_fouls_rolling_avg(data, home_team, match_date=None, window=window_):
    if match_date is None:
        match_date = datetime.now()
    home_matches = data[data['HomeTeam'] == home_team]
    home_matches = home_matches[home_matches['Date'] < match_date]
...
def compute_away_fouls_rolling_avg(data, away_team, match_date=None, window=window_):
    if match_date is None:
        match_date = datetime.now()
    away_matches = data[data['AwayTeam'] == away_team]
    away_matches = away_matches[away_matches['Date'] < match_date]
...
def compute_home_corners_rolling_avg(data, home_team, match_date=None, window=window_):
...
def compute_away_corners_rolling_avg(data, away_team, match_date=None, window=window_):
...
def compute_home_goals_rolling_avg(data, home_team, match_date=None, window=window_):
...
def compute_away_goals_rolling_avg(data, away_team, match_date=None, window=window_):
...
def compute_home_shots_on_target_rolling_avg(data, home_team, match_date=None, window=window_):
...
def compute_away_shots_on_target_rolling_avg(data, away_team, match_date=None, window=window_):
...
def compute_team_shots_rolling_avg(data, team_name, is_home, match_date=None, window=window_):
...
def estimate_total_shots(data, home_team, away_team, match_date=None, window=window_):
...
def compute_team_corners_rolling_avg(data, team_name, is_home, match_date=None, window=window_):
...
def estimate_total_corners(data, home_team, away_team, match_date=None, window=window_):
...
def calculate_match_features(home_team, away_team, data, match_date=None, window=window_):
    """
