...
def prepare_match_prediction(home_team, away_team):
    match_features = {
        ...
        'HS': 12.2, 'AS': 10.6, 'HF': 15.2, 'AF': 10.4, 'HC': 4.8, 'AC': 5.8,
        'RollingAvg_FTHG': 0.4, 'RollingAvg_FTAG': 0.8,
        'RollingAvg_TotalShots': 22.8, 'RollingAvg_TotalCorners': 10.6,
        'RollingAvg_HomeHST': 3.6, 'RollingAvg_AwayAST': 3.8,
        'HomeTeam_Form': 3, 'AwayTeam_Form': 2
    }
