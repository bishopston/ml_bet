...
# Example usage
data = pd.read_csv('../sp1/24_25/SP1_070425.csv')  # Make sure this is the correct path to your CSV
data['Date'] = pd.to_datetime(data['Date'])  # Ensure the 'Date' column is in datetime format

# List of upcoming matches
upcoming_matches = pd.DataFrame({
    'HomeTeam': ['Valencia', 'Sociedad', 'Getafe', 'Celta', 'Leganes', 'Osasuna', 'Alaves', 'Betis', 'Ath Bilbao', 'Ath Madrid'],
    'AwayTeam': ['Sevilla', 'Mallorca', 'Las Palmas', 'Espanol', 'Barcelona', 'Girona', 'Real Madrid', 'Villarreal', 'Vallecano', 'Valladolid']
})
