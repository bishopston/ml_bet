...
# Example usage
data = pd.read_csv('../e0/24_25/E0_070425.csv')  # Make sure this is the correct path to your CSV
data['Date'] = pd.to_datetime(data['Date'])  # Ensure the 'Date' column is in datetime format

# List of upcoming matches
upcoming_matches = pd.DataFrame({
    'HomeTeam': ['Man City', 'Southampton', 'Nott\'m Forest', 'Brighton', 'Arsenal', 'Chelsea', 'Wolves', 'Liverpool', 'Newcastle', 'Bournemouth'],
    'AwayTeam': ['Crystal Palace', 'Aston Villa', 'Everton', 'Leicester', 'Brentford', 'Ipswich', 'Tottenham', 'West Ham', 'Man United', 'Fulham']
})
