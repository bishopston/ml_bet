...
def prepare_match_prediction(home_team, away_team):
    ...
    match_features = {
        'HomeTeam': home_team,
        'AwayTeam': away_team,
        'HS': 15.2,      # Average home team shots per match
        'AS': 14,       # Average away team shots per match
        #'HST': 4,      # Average home team shots on target
        #'AST': 3,      # Average away team shots on target
        'HF': 11.6,      # Average home team fouls
        'AF': 13.6,      # Average away team fouls
        'HC': 6.4,       # Average home team corners
        'AC': 4.8,       # Average away team corners
        ...
        #'B365H': 8, 'B365D': 3, 'B365A': 1.6,  # Typical bookmaker odds
        #'TotalShots': 21,  # Average total shots per match
        #'TotalCorners': 9,   # Average total corners per match
        'RollingAvg_FTHG': 2.0,  # Average home team goals
        'RollingAvg_FTAG': 1.8,  # Average away team goals conceded
        'RollingAvg_TotalShots': 29.2,
        'RollingAvg_TotalCorners': 11.2,
        'RollingAvg_HomeHST': 4.6,
        'RollingAvg_AwayAST': 3.4,
        # 'RollingAvg_HomeHS': 7,
        # 'RollingAvg_AwayAS': 7,
        # 'RollingAvg_HomeHC': 6,
        # 'RollingAvg_AwayAC': 6,
...
# Example usage
team_names = ['Arsenal', 'Fulham']  # Note the correct team name format
# print("team_names_0 " + team_names[0])
# print("team_names_1 " + team_names[1])
